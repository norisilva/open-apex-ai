...
python -m PyInstaller --clean --noconfirm --onefile --windowed --name "OpenApexAI" --add-data "data;data" --add-data "ui\overlay;ui\overlay" --add-data "core\scraper;core\scraper" --add-data "core\transformer;core\transformer" --add-data "core\i18n\locales;core\i18n\locales" --add-data "%P_BROWSERS%;playwright\driver\package\.local-browsers" --icon=NONE main.py
